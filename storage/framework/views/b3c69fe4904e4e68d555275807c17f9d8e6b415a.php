                            ...
                            <div class="card-body" id="print">
                                <div class="row mb-5">
                                    <div class="mt-4 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                        <h6>From:</h6>
                                        <div> <strong><?php echo e(session('user')->name); ?></strong> </div>
                                        <div>HIS Admin</div>
                                        <div><?php echo e(session('user')->address); ?></div>
                                        <div>Email: <?php echo e(session('user')->email); ?></div>
                                        <div>Phone: 0<?php echo e(session('user')->phone); ?></div>
                                    </div>
                                    <div class="mt-4 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                        <h6>To:</h6>
                                        <div> <strong><?php echo e($apps->user->name); ?></strong> </div>

                                        <div><?php echo e($apps->user->address); ?></div>
                                        <div>Email:<?php echo e($apps->user->email); ?></div>
                                        <div>Phone: 0<?php echo e($apps->phone); ?></div>
                                    </div>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="left strong"><?php echo e($apps->id); ?></td>
                                                <td class="left strong"><?php echo e($apps->pname); ?></td>
                                                <td class="left strong"><?php echo e($apps->doctor->service->name); ?></td>
                                                <td class="left">$<?php echo e($apps->doctor->service->price); ?></td>
                                                <td class="right"><?php echo e($apps->date); ?></td>
                                                <td class="center">$<?php echo e($apps->doctor->service->price); ?></td>
                                        ...
                                        <table class="table table-clear">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="right"><strong>$<?php echo e($apps->doctor->service->price); ?></strong><br>
...
</html><?php /**PATH F:\projects\summer train 2022\His project last edit v2\resources\views/appointments/print.blade.php ENDPATH**/ ?>