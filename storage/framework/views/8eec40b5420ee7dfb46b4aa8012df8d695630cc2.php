                        ...
                        <div class="card mt-3">
                            ...
                            <div class="card-body" id="print">
                                <div class="row mb-5">
                                    ...
                                    <div class="mt-4 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                        <h6>To:</h6>
                                        <div> <strong><?php echo e($aps->name); ?></strong> </div>

                                        <div><?php echo e($aps->address); ?></div>
                                        <div>Email:<?php echo e($aps->email); ?></div>
                                        <div>Phone: 0<?php echo e($aps->phone); ?></div>
                                    </div>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="left strong"><?php echo e($aps->id); ?></td>
                                                <td class="left strong"><?php echo e($aps->name); ?></td>
                                                <td class="left strong"><?php echo e($aps->service->name); ?></td>
                                                <td class="left">$<?php echo e($aps->service->price); ?></td>
                                                <td class="right"><?php echo e($aps->date); ?></td>
                                                <td class="center">$<?php echo e($aps->total); ?></td>
                                        ...
                                        <table class="table table-clear">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="right"><?php echo e($aps->discount); ?></td>
                                                </tr>

                                                <tr>
                                                    <td class="left"><strong>Total</strong></td>
                                                    <td class="right"><strong>$<?php echo e($aps->total); ?></strong><br>
...
</html><?php /**PATH F:\projects\summer train 2022\His project last edit v2\resources\views/invoice/print.blade.php ENDPATH**/ ?>