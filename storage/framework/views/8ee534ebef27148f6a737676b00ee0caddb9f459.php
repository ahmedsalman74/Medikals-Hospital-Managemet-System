  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <div>
        ...
        <a href="<?php echo e(route('index', session('user')->id)); ?>"> <button type="submit" value="submit"><span class="buttonSpan"></span>Confirm</button></a>
      </div>
...
<?php /**PATH D:\Programs\laravel\His project v1\resources\views/show.blade.php ENDPATH**/ ?>