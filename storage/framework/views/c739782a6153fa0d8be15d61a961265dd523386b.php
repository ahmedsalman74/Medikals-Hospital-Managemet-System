                                        ...
                                        <div class="basic-form">
                                            <form>
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="name" id="name" class="form-control" value="<?php echo e($users->name); ?>">
                                                    </div>
                                                </div>
                                                <div class="input-group mb-3">
                                                    <label class="col-sm-3 col-form-label">Email</label>
                                                    <div class="col-sm-9">
                                                        <input input type="email" name="email" id="email" class="form-control" value="<?php echo e($users->email); ?>">
...
unset($__errorArgs, $__bag); ?>
                                                <div class="input-group mb-3">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input input type="phone" name="phone" id="phone" class="form-control" value="<?php echo e($users->phone); ?>">
                                                    </div>
                                                </div>
                                                <div class="input-group mb-3">
                                                        <label class="col-sm-3 col-form-label">Address</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" name="address" id="address" class="form-control" value="<?php echo e($users->address); ?>">
                                                        </div>
                                                    </div>
...
</html><?php /**PATH F:\projects\summer train 2022\His project last edit v2\resources\views/cruduser/update.blade.php ENDPATH**/ ?>