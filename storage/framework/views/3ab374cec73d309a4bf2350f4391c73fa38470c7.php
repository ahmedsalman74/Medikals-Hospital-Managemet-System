                                    ...
                                    <table class="table table-responsive-md">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e($app->pname); ?></td>
                                                <td><?php echo e($app->doctor->service->name); ?></td>
                                                <td><?php echo e($app->doctor->name); ?></td>
                                                <td><span class="badge light badge-success"><?php echo e($app->date); ?></span></td>
                                                <td>0<?php echo e($app->phone); ?></td>
                                                <td id="action">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="<?php echo e(route('apointments.print',$app->id)); ?>">Bill</a>
                                                            <a class="dropdown-item" href="<?php echo e(route('apointments.destroy',$app->id)); ?>">Delete</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
...
</html><?php /**PATH F:\projects\summer train 2022\His project last edit v2\resources\views/appointments/index.blade.php ENDPATH**/ ?>