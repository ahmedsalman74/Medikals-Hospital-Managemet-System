                        ...
                        <div class="card mt-3">
                            ...
                            <div class="card-body" id="print">
                                <div class="row mb-5">
                                    ...
                                    <div class="mt-4 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                        <h6>To:</h6>
                                        <div> <strong>{{$aps->name}}</strong> </div>

                                        <div>{{$aps->address}}</div>
                                        <div>Email:{{$aps->email}}</div>
                                        <div>Phone: 0{{$aps->phone}}</div>
                                    </div>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="left strong">{{$aps->id}}</td>
                                                <td class="left strong">{{$aps->name}}</td>
                                                <td class="left strong">{{$aps->service->name}}</td>
                                                <td class="left">${{$aps->service->price}}</td>
                                                <td class="right">{{$aps->date}}</td>
                                                <td class="center">${{$aps->total}}</td>
                                        ...
                                        <table class="table table-clear">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="right">{{$aps->discount}}</td>
                                                </tr>

                                                <tr>
                                                    <td class="left"><strong>Total</strong></td>
                                                    <td class="right"><strong>${{$aps->total}}</strong><br>
