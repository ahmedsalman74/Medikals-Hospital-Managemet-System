  ...
  <div class="container" id="print">
    ...
    <div class="content">
      <form action="">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <label type="text"><?php echo e($aps->date); ?></label>
          </div>
          <br><br>
            <div class="input-box">
              <p style="font-family: 'Poppins';" class="details">-Your final charge is: <span><?php echo e($aps->doctor->service->price); ?> EGP </span></p>    
           </div>
        </div>
      ...
      <div>
        ...
        <a href="<?php echo e(route('index', session('user')->id)); ?>"> <button type="submit" id="comfirm_Button" value="submit"><span class="buttonSpan"></span>Continue</button></a>
...
</html><?php /**PATH F:\projects\summer train 2022\His project last edit v2\resources\views/show.blade.php ENDPATH**/ ?>